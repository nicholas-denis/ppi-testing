...
def build_paths(config: dict):
    ...
    if not os.path.exists(os.path.join(experiment_path, 'results')):
        ...
        print(f"{YELLOW}Created results folder: {os.path.join(experiment_path, 'results')}{RESET}")
        # write the results folder path to the config file
        config['paths']['results_path'] = os.path.join(experiment_path, 'results')
...
def main(config: dict):
    ...
    results_raw.to_csv(os.path.join(config['paths']['results_path'], 'results.csv'))
    results_mean.to_csv(os.path.join(config['paths']['results_path'], 'results_mean.csv'))
