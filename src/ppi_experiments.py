    ...
    for metric in config['experiment']['metrics']['primary']:
        if metric == 'widths':
            if 'width' in config['experiment']['metrics']:
                ...
                plt.plot(config['experiment']['ind_var']['vals'], metrics_dict['ppi_widths'], label='PPI Mean Widths', marker='o')
                plt.plot(config['experiment']['ind_var']['vals'], metrics_dict['naive_widths'], label='Naive Mean Widths', marker='x')
                plt.plot(config['experiment']['ind_var']['vals'], metrics_dict['classical_widths'], label='Classical Mean Widths', marker='s')
                ...
                plt.savefig(os.path.join(config['paths']['plotting_path'], 'widthsplot.png'))
    return 
